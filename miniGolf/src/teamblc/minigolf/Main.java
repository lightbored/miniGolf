...
public class Main {
    ...
    static void enterStrokes ( String courseName, String playerName, int strokes ) { //This method is redundant.  It also will be used by the swipe-station once a player hits the button for their number of strokes for that hole.
